...
import { ArrowLeft, Star, BarChart3, Activity } from "lucide-react";
    ...
    <motion.div {...pageTransition} className="p-3 md:p-4 space-y-3 md:space-y-4">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="text-lg md:text-xl font-bold font-mono text-foreground">{symbol}</h1>
            {opp && <span className="text-xs md:text-sm text-muted-foreground truncate">{opp.company}</span>}
          </div>
        </div>
        <div className="ml-auto flex items-center gap-2 md:gap-4 shrink-0">
          ...
          <button className="p-1.5 md:p-2 rounded border border-border hover:border-primary/40 transition-colors">
            <Star className="h-3.5 md:h-4 w-3.5 md:w-4 text-muted-foreground" />
          </button>
        </div>
      </div>
      ...
      {opp && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3">
          <div className="rounded-md border border-border bg-card p-2.5 md:p-3">
          ...
          <div className="rounded-md border border-border bg-card p-2.5 md:p-3">
            ...
            <div className="text-xs md:text-sm text-foreground">{opp.trigger}</div>
          </div>
        </div>
      )}
